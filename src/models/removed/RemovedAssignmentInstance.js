module.exports = function (sequelize, DataTypes) {
    var RemovedAssignmentInstance = sequelize.define('RemovedAssignmentInstance', {
    ...
    RemovedAssignmentInstance.associate = function (models) {
        models.RemovedAssignmentInstance.belongsTo(models.Section, {
            foreignKey: 'SectionID',
        });
        models.RemovedAssignmentInstance.belongsTo(models.RemovedAssignment, {
            foreignKey: 'AssignmentID',
        });
        models.RemovedAssignmentInstance.belongsTo(models.Assignment, {
            foreignKey: 'AssignmentID',
        });
    };

    return RemovedAssignmentInstance;
};
