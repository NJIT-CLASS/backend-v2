module.exports = function (sequelize, DataTypes) {
    var TaskActivity = sequelize.define('TaskActivity', {
        TaskActivityID: {
    ...
    TaskActivity.associate = function (models) {
        models.TaskActivity.belongsTo(models.WorkflowActivity, {
            foreignKey: 'WorkflowActivityID',
        });
        models.TaskActivity.belongsTo(models.AssignmentInstance, {
            foreignKey: 'AssignmentInstanceID',
        });
        models.TaskActivity.belongsTo(models.Assignment, {
            foreignKey: 'AssignmentID',
        });
        models.TaskActivity.hasMany(models.TaskInstance, {
            as: 'TaskInstances',
