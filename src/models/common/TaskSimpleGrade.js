module.exports = function (sequelize, DataTypes) {
    var TaskSimpleGrade = sequelize.define('TaskSimpleGrade', {
        TaskSimpleGradeID: {
            //TaskSimple grade ID
    ...
    TaskSimpleGrade.associate = function (models) {
        models.TaskSimpleGrade.belongsTo(models.TaskInstance, {
            foreignKey: 'TaskInstanceID',
        });
        models.TaskSimpleGrade.belongsTo(models.WorkflowActivity, {
            foreignKey: 'WorkflowActivityID',
        });
        models.TaskSimpleGrade.belongsTo(models.SectionUser, {
            foreignKey: 'SectionUserID',
        });
    };

    return TaskSimpleGrade;
};
