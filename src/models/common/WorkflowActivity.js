module.exports = function (sequelize, DataTypes) {
    var WorkflowActivity = sequelize.define('WorkflowActivity', {
        WorkflowActivityID: {
    ...
    WorkflowActivity.associate = function (models) {
        models.WorkflowActivity.belongsTo(models.Assignment, {
            foreignKey: 'AssignmentID',
        });
        models.WorkflowActivity.hasMany(models.WorkflowInstance, {
