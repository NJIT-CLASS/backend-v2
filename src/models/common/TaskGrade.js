module.exports = function (sequelize, DataTypes) {
    var TaskGrade = sequelize.define('TaskGrade', {
        TaskGradeID: {
            //Task grade ID
    ...
    TaskGrade.associate = function (models) {
        models.TaskGrade.belongsTo(models.TaskInstance, {
            foreignKey: 'TaskInstanceID',
        });
        models.TaskGrade.belongsTo(models.WorkflowActivity, {
            foreignKey: 'WorkflowActivityID',
        });
        models.TaskGrade.belongsTo(models.SectionUser, {
