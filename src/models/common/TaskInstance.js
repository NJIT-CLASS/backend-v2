module.exports = function (sequelize, DataTypes) {
    var TaskInstance = sequelize.define('TaskInstance', {
        TaskInstanceID: {
    ...
    TaskInstance.associate = function (models) {
        models.TaskInstance.belongsTo(models.TaskActivity, {
            foreignKey: 'TaskActivityID',
        });
        models.TaskInstance.belongsTo(models.WorkflowInstance, {
            foreignKey: 'WorkflowInstanceID',
        });
        models.TaskInstance.belongsTo(models.User, {
            foreignKey: 'UserID',
        });
        models.TaskInstance.belongsTo(models.AssignmentInstance, {
