module.exports = function (sequelize, DataTypes) {
    var WorkflowInstance = sequelize.define('WorkflowInstance', {
        WorkflowInstanceID: {
    ...
    WorkflowInstance.associate = function (models) {
        models.WorkflowInstance.belongsTo(models.WorkflowActivity, {
            foreignKey: 'WorkflowActivityID',
        });
        models.WorkflowInstance.belongsTo(models.AssignmentInstance, {
            foreignKey: 'AssignmentInstanceID',
        });
        models.WorkflowInstance.hasMany(models.TaskInstance, {
            as: 'TaskInstances',
